...
$source_path = '/home/wwwroot/default/tmphtml'; # 最后不加 /

if(php_sapi_name() === 'cli'){
    $source_path = trim($argv[1]);
    if(empty($source_path) or !file_exists($source_path)) die("\r\n   $source_path 该目录不存在，请重新输入\r\n");
}
echo $source_path;
...
#$footer = file_get_contents($source_path . '/category.html');
