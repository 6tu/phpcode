...
<form name="myform" method="post" action="<?=$_SERVER[PHP_SELF];?>">
  <font color="#FF0000">A5互联 -web在线ZIP文件压缩打包程序 V2.0</font><br>

<div style="color:#FF9900">
   <p>转载请注明：本程序由A5互联<a href="http://www.A5dns.com/" target="_blank" class="STYLE1"></a><a href="http://www.mxpan.com/" target="_blank"></a>(<a href="http://www.A8dns.com/" target="_blank">http://www.A5dns.Com</a>) 提供,作者：<span class="STYLE1">双鱼座boyヽ</span><span class="STYLE6">QQ：772780870</span></p>
...
<tr>
      ...
      (源文件中设定的密码，<span class="STYLE6">默认为：A5dns</span>) </td>
    </tr> 
    <tr>
...
?>
  <br>
  压缩文件保存到目录: 
  <input name="todir" type="text" id="todir" value="__A5dns.BAK__" size="15"> 
  (留空为本目录,必须有写入权限)<br>
  压缩文件名称:
  <input name="zipname" type="text" id="zipname" value="A5dns.zip" size="15">
  (.zip) <span class="STYLE4">备注;在文件的头部 $password = &quot;A5dns&quot;;的A5dns可以改成你的密码</span><br>
  <br> 
