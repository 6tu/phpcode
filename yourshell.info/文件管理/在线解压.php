...
<title>mxpan  - www.mxpan.com</title>
<style type="text/css">
<!--
body,td{
	font-size: 14px;
...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
    <tr>
      <td height="40" colspan="2" style="color:#FF9900"><p><font color="#FF0000">A5互联 -web在线ZIP文件解压程序 V2.0</font></p>
	    <p>转载请注明：本程序由 <a href="http://www.A8dns.com/" target="_blank" class="STYLE1">A8互联提供</a>(<a href="http://www.A5dns.com/" target="_blank">http://www.A5dns.Com</a>) 提供,作者：<a href="http://www.A5dns.com/" target="_blank" class="STYLE1">双鱼座boyヽ</a>(QQ：772780870).</p>
...
?>
	...
	<tr>
      <td>解压到目录: </td>
      <td><input name="todir" type="text" id="todir" value="__A5dns__" size="15"> 
      (留空为本目录,必须有写入权限)</td>
    </tr>
	<tr>
      <td>验证密码: </td>
      <td><input name="password" type="password" id="password" size="15"> 
        (源文件中设定的密码，<span class="STYLE3">默认为：A8dns</span>)</td>
    </tr>	
    <tr>
