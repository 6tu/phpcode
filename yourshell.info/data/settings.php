...
$CONFIG['hotlink_domains'] = array('http://google.com');
...
$CONFIG['cache_file_types'] = array('css', 'jpg', 'jpeg', 'png', 'gif', 'js', 'flv', 'zip', 'rar', '7z');
...
$CONFIG['options']['allowCookies'] = array(
   'title'   => 'Allow Cookies',
   'desc'    => 'Cookies may be required on interactive websites (especially where you need to log in) but advertisers also use cookies to track your browsing habits.广告商能用 cookies 跟踪您的浏览习惯',
   'default' => true,
   'force'   => true
);
...
$CONFIG['options']['tempCookies'] = array(
   ...
   'desc'    => '关闭浏览器Cookies即失效This option overrides the expiry date for all cookies and sets it to at the end of the session only - all cookies will be deleted when you shut your browser. (Recommended)',
   'default' => false,
   'force'   => true
);
